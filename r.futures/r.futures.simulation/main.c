...
int main(int argc, char **argv)
{
    ...
    struct {
        struct Option *developed, *subregions, *potentialSubregions,
            ...
            *incentivePower, *potentialWeight, *cellDemandFile,
            *populationDemandFile, *separator, *density, *densityCapacity,
            *outputDensity, *redevelopmentLag, *redevelopmentPotentialFile,
